...
<body>
	<h1 style="color: violet; font-size: 40px;" align="center">HEY WE DEPLOYED OUR APP USING harsha</h1>
	<h1 style="color: red; font-size: 40px;" align="center">THIS IS APP DEPLOYMENT USING vardhan</h1>
	<h1 style="color: green; font-size: 40px;" align="center">hello this nexus</h1>
